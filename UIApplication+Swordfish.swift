...
extension UIApplication {
    func Swordfish_sendAction(action: Selector, to: AnyObject?, from: AnyObject?, forEvent: UIEvent?) -> Bool {
        var eventMap: [String: AnyObject] = ["selector": NSStringFromSelector(action), "to_object": NSStringFromClass(to?.dynamicType), "from_object": NSStringFromClass(from?.dynamicType)]
        if (forEvent != nil) {
            var subDict: [String: AnyObject] = ["name": NSStringFromClass(forEvent!.dynamicType), "type": forEvent!.type.rawValue]
